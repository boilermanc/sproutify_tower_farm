...
import 'add_new_product_copy_model.dart';
export 'add_new_product_copy_model.dart';

class AddNewProductCopyWidget extends StatefulWidget {
  const AddNewProductCopyWidget({super.key});

  @override
  State<AddNewProductCopyWidget> createState() =>
      _AddNewProductCopyWidgetState();
}

class _AddNewProductCopyWidgetState extends State<AddNewProductCopyWidget> {
  late AddNewProductCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewProductCopyModel());
