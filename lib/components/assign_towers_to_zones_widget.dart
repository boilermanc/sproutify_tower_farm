...
import 'assign_towers_to_zones_model.dart';
export 'assign_towers_to_zones_model.dart';

class AssignTowersToZonesWidget extends StatefulWidget {
  const AssignTowersToZonesWidget({
    super.key,
    this.parameter1,
    this.parameter2,
  });
  ...
  @override
  State<AssignTowersToZonesWidget> createState() =>
      _AssignTowersToZonesWidgetState();
}

class _AssignTowersToZonesWidgetState extends State<AssignTowersToZonesWidget> {
  late AssignTowersToZonesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssignTowersToZonesModel());
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return ListView
                                                                        ...
                                                                        scrollDirection:
                                                                            Axis.vertical,
                                                                        itemCount:
                                                                            draggableTowerList.length,
                                                                        itemBuilder:
                                                                            (context,
                                                                                draggableTowerListIndex) {
                                                                          final draggableTowerListItem =
                                                                              draggableTowerList[draggableTowerListIndex];
                                                                          return Padding(
                                                                            padding: EdgeInsetsDirectional.fromSTEB(
                                                                                5.0,
                                                                                1.0,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  Draggable<String>(
                                                                                    data: draggableTowerListItem.towerIdentifier!,
                                                                                    feedback: Material(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        ...
                                                                                        child: Text(
                                                                                          valueOrDefault<String>(
                                                                                            draggableTowerListItem.towerIdentifier,
                                                                                            '0.00',
                                                                                          ),
