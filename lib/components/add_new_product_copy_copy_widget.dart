...
import 'add_new_product_copy_copy_model.dart';
export 'add_new_product_copy_copy_model.dart';

class AddNewProductCopyCopyWidget extends StatefulWidget {
  const AddNewProductCopyCopyWidget({super.key});

  @override
  State<AddNewProductCopyCopyWidget> createState() =>
      _AddNewProductCopyCopyWidgetState();
}

class _AddNewProductCopyCopyWidgetState
    extends State<AddNewProductCopyCopyWidget> {
  late AddNewProductCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewProductCopyCopyModel());
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          'Enter any additonal notes or description',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Plus Jakarta Sans',
