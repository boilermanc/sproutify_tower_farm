                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.waterSourceEntryTextController,
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  10.0, 0.0, 0.0, 0.0),
                              child: FutureBuilder<List<TestTypesRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    controller:
                                        _model.testTypeEntryValueController ??=
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.testResultEntryTextController,
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  10.0, 0.0, 0.0, 0.0),
                              child: FutureBuilder<List<TestUnitsRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    controller:
                                        _model.testUnitEntryValueController ??=
                                            FormFieldController<String>(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  10.0, 0.0, 0.0, 0.0),
                              child: FutureBuilder<List<TestStandardsRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    controller: _model
                                            .testStandardEntryValueController ??=
                                        FormFieldController<String>(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  10.0, 0.0, 0.0, 0.0),
                              child: FutureBuilder<List<ComplianceStatusesRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    controller: _model
                                            .complianceStatusEntryValueController ??=
                                        FormFieldController<String>(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  10.0, 0.0, 0.0, 0.0),
                              child: FutureBuilder<List<FarmVendorsViewRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<FarmVendorsViewRow>
                                      vendorEntryFarmVendorsViewRowList =
                                      snapshot.data!;

                                  return FlutterFlowDropDown<String>(
                                    controller:
                                        _model.vendorEntryValueController ??=
                                            FormFieldController<String>(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await WaterQualityTestsTable().insert({
                                    ...
                                    'test_date': supaSerialize<DateTime>(
                                        _model.datePicked),
                                    'water_source': _model
                                        .waterSourceEntryTextController.text,
                                    'test_type_id': _model.testTypeEntryValue,
                                    'test_result': double.tryParse(_model
                                        .testResultEntryTextController.text),
