...
class AddInitialTowersWidget extends StatefulWidget {
  const AddInitialTowersWidget({super.key});

  @override
  State<AddInitialTowersWidget> createState() => _AddInitialTowersWidgetState();
}

class _AddInitialTowersWidgetState extends State<AddInitialTowersWidget> {
  late AddInitialTowersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddInitialTowersModel());
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: Text(
                                            'Let\'s configure your vertical farm towers for optimal growing.',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts
