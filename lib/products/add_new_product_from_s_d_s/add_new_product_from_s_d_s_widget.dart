...
import 'add_new_product_from_s_d_s_model.dart';
export 'add_new_product_from_s_d_s_model.dart';

class AddNewProductFromSDSWidget extends StatefulWidget {
  const AddNewProductFromSDSWidget({super.key});

  @override
  State<AddNewProductFromSDSWidget> createState() =>
      _AddNewProductFromSDSWidgetState();
}

class _AddNewProductFromSDSWidgetState
    extends State<AddNewProductFromSDSWidget> {
  late AddNewProductFromSDSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewProductFromSDSModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.productName9988 = await ProductItemSdsCreationTable().queryRows(
        queryFn: (q) => q,
      );
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    _model.addedProdcut3939 =
                                      ...
                                      'product_name': _model.productName,
                                      'product_category_id':
                                          _model.categoryValue,
