...
import 'main_water_management_model.dart';
export 'main_water_management_model.dart';
...
class _MainWaterManagementWidgetState extends State<MainWaterManagementWidget>
    with TickerProviderStateMixin {
  late MainWaterManagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainWaterManagementModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<WaterQualityTestDetailsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<WaterQualityTestDetailsRow>
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        'Welcome to your comprehensive water management dashboard, designed to ensure sustainable and efficient water use across your farm. Track and analyze water quality and consumption in one place for optimal resource management.',
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      16.0, 0.0, 0.0, 0.0),
                                              child: Text(
                                                'Below is a summary of your water quality.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                                                ...
                                                child: FutureBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    List<WaterFlowAggregationRow>
                                                        todaysWaterDetailsWaterFlowAggregationRowList =
                                                        snapshot.data!;

                                                    final todaysWaterDetailsWaterFlowAggregationRow =
                                                        todaysWaterDetailsWaterFlowAggregationRowList
                                                                .isNotEmpty
                                                            ? todaysWaterDetailsWaterFlowAggregationRowList
                                                                .first
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    formatNumber(
                                                                      todaysWaterDetailsWaterFlowAggregationRow!
                                                                          .latestReading!,
                                                                      formatType:
                                                                          FormatType
                                                                              .decimal,
                                              ...
                                              Padding(
                                                ...
                                                child: FutureBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    List<WaterFlowAggregationRow>
                                                        gravityTankWaterFlowAggregationRowList =
                                                        snapshot.data!;

                                                    final gravityTankWaterFlowAggregationRow =
                                                        gravityTankWaterFlowAggregationRowList
                                                                .isNotEmpty
                                                            ? gravityTankWaterFlowAggregationRowList
                                                                .first
