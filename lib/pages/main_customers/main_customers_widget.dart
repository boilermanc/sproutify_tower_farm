...
class _MainCustomersWidgetState extends State<MainCustomersWidget> {
  late MainCustomersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainCustomersModel());
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 10.0),
                            child: FutureBuilder<List<CustomerCareSayingsRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<CustomerCareSayingsRow>
                                    containerCustomerCareSayingsRowList =
                                    snapshot.data!;

                                final containerCustomerCareSayingsRow =
                                    containerCustomerCareSayingsRowList
                                            .isNotEmpty
                                        ? containerCustomerCareSayingsRowList
                                            .first
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Search all customers...',
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return FlutterFlowDataTable<
                                        ...
                                        dataRowBuilder: (farmCustomersItem,
                                                farmCustomersIndex,
                                                selected,
                                                onSelectChanged) =>
                                            DataRow(
                                          color: MaterialStateProperty.all(
                                            farmCustomersIndex % 2 == 0
                                                ? FlutterFlowTheme.of(context)
                                                    .secondaryBackground
                                                : FlutterFlowTheme.of(context)
                                                    .primaryBackground,
                                          ...
                                          cells: [
                                            Text(
                                              valueOrDefault<String>(
                                                farmCustomersItem.customerName,
                                                ' Customer Name',
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                            ...
                                            Text(
                                              valueOrDefault<String>(
                                                farmCustomersItem.contactNumber,
                                                ' No Contact Number',
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
