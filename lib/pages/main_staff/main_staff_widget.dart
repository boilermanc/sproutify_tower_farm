...
class _MainStaffWidgetState extends State<MainStaffWidget> {
  late MainStaffModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainStaffModel());
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<List<RolesRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<RolesRow> choiceChipsRolesRowList =
                                          snapshot.data!;

                                      return FlutterFlowChoiceChips(
                                        options: choiceChipsRolesRowList
                                            .map((e) => e.roleName)
                                            .toList()
