...
import 'main_nutrients_copy_model.dart';
export 'main_nutrients_copy_model.dart';

class MainNutrientsCopyWidget extends StatefulWidget {
  const MainNutrientsCopyWidget({super.key});

  static String routeName = 'main_NutrientsCopy';
  static String routePath = '/mainNutrientsCopy';

  @override
  State<MainNutrientsCopyWidget> createState() =>
      _MainNutrientsCopyWidgetState();
}

class _MainNutrientsCopyWidgetState extends State<MainNutrientsCopyWidget>
    with TickerProviderStateMixin {
  late MainNutrientsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainNutrientsCopyModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FutureBuilder<
                              ...
                              future:
                                  MonitoringIntelligenceViewTable().queryRows(
                                queryFn: (q) => q
                                    .eqOrNull(
                                      'severity',
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: FutureBuilder<
                                                              ...
                                                              builder: (context,
                                                                ...
                                                                final columnMonitoringIntelligenceViewRow =
                                                                    columnMonitoringIntelligenceViewRowList
                                                                            .isNotEmpty
                                                                        ? columnMonitoringIntelligenceViewRowList
                                                                            .first
