  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().localTemp = GetOpenWeatherCall.localTemp(
        (_model.farmWeather8888?.jsonBody ?? ''),
      )!
          .toString();
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return GestureDetector(
                                                                            ...
                                                                            child:
                                                                                Padding(
                                                                              padding: MediaQuery.viewInsetsOf(context),
                                                                              child: ProfileUpdateComponentWidget(),
                                                                            ),
                                                                          );
                                                                        },
                                                                      ).then((value) =>
                                                                    ...
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        child: FutureBuilder<
                                                                          ...
                                                                          future:
                                                                              LatestLightStatusTable().queryRows(
                                                                            queryFn: (q) => q
                                                                                .eqOrNull(
                                                                                  'farm_id',
                                                                                  FFAppState().farmID,
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                                FutureBuilder<List<TowerDisplayWithPlantsRow>>(
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                                FutureBuilder<List<PlantDistributionBreakdownRow>>(
