...
class _MainNutrientsWidgetState extends State<MainNutrientsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.farmMonitoringData1111 =
          await MonitoringSummaryDashboardTable().queryRows(
        queryFn: (q) => q.eqOrNull(
          'farm_id',
          FFAppState().farmID,
        ),
      );
      _model.ecIssues = _model.farmMonitoringData1111?.firstOrNull?.ecIssues;
      _model.phIssues = _model.farmMonitoringData1111?.firstOrNull?.phIssues;
      _model.noIssues = _model.farmMonitoringData1111?.firstOrNull?.noIssues;
      safeSetState(() {});
    });
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 4.0, 0.0, 0.0),
                                  child: Text(
                                    'Your pH & EC Snapshot – Let\'s Keep Things Balanced!',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                ...
                                children: [
                                  ...
                                  FutureBuilder<
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<MonitoringTowerDashboardEnhancedWithValuesRow>
                                          phecDataMonitoringTowerDashboardEnhancedWithValuesRowList =
                                          snapshot.data!;
