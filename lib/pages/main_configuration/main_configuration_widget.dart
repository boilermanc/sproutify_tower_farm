...
import 'main_configuration_model.dart';
export 'main_configuration_model.dart';
...
class _MainConfigurationWidgetState extends State<MainConfigurationWidget> {
  late MainConfigurationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainConfigurationModel());
