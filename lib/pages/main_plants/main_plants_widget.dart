...
import 'main_plants_model.dart';
export 'main_plants_model.dart';
...
class _MainPlantsWidgetState extends State<MainPlantsWidget> {
  late MainPlantsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainPlantsModel());
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    'Your Plant Portfolio - Growing Stronger Every Day!',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return FlutterFlowDataTable<
                                        ...
                                        dataRowBuilder: (farmPlantListItem,
                                                farmPlantListIndex,
                                                selected,
                                                onSelectChanged) =>
                                            DataRow(
