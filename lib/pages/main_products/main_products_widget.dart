                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 0.0, 0.0, 0.0),
                            child: Text(
                              'Below is a list of products used on your farm.',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                          ...
                          Padding(
                            ...
                            child:
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ProductDashboardMetricsRow>
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        16.0, 0.0, 0.0, 0.0),
                                                child: Text(
                                                  'Below is a summary of the farms products.',
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return FlutterFlowDataTable<
                                        ...
                                        dataRowBuilder: (farmProductsItem,
                                                farmProductsIndex,
                                                selected,
                                                onSelectChanged) =>
                                            DataRow(
                                          color: MaterialStateProperty.all(
                                            farmProductsIndex % 2 == 0
                                                ? FlutterFlowTheme.of(context)
                                                    .secondaryBackground
                                                : FlutterFlowTheme.of(context)
                                                    .primaryBackground,
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      return FlutterFlowDataTable<
                                        ...
                                        dataRowBuilder: (pesticideProductsItem,
                                                pesticideProductsIndex,
                                                selected,
                                                onSelectChanged) =>
                                            DataRow(
                                          color: MaterialStateProperty.all(
                                            pesticideProductsIndex % 2 == 0
                                                ? FlutterFlowTheme.of(context)
                                                    .secondaryBackground
                                                : FlutterFlowTheme.of(context)
                                                    .primaryBackground,
