                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 5.0, 0.0, 0.0),
                            child: Text(
                              'Monitor and control farm equipment to optimize operations, reduce energy costs, and ensure reliable performance.',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      16.0, 0.0, 0.0, 0.0),
                                              child: Text(
                                                'Below is a summary of the farms mechanicals',
                                                style:
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 8.0, 0.0, 0.0),
                                          child: FutureBuilder<
                                              List<MechanicalDashboardViewRow>>(
                                            future:
                                                MechanicalDashboardViewTable()
                                                    .querySingleRow(
                                              queryFn: (q) => q.eqOrNull(
                                                'farm_id',
                                                FFAppState().farmID,
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<MechanicalDashboardViewRow>
                                                  listViewMechanicalDashboardViewRowList =
                                                  snapshot.data!;

                                              final listViewMechanicalDashboardViewRow =
                                                  listViewMechanicalDashboardViewRowList
                                                          .isNotEmpty
                                                      ? listViewMechanicalDashboardViewRowList
                                                          .first
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<
                                                                            String>(
                                                                          listViewMechanicalDashboardViewRow
                                                                              ?.currentEnergyUsageKwh
                                                                              ?.toString(),
                                                                          '0',
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                          ...
                          FutureBuilder<List<MechanicalDashboardViewRow>>(
                            future: MechanicalDashboardViewTable().queryRows(
                              queryFn: (q) => q.eqOrNull(
                                'farm_id',
                                FFAppState().farmID,
                              ),
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<MechanicalDashboardViewRow>
                                  containerMechanicalDashboardViewRowList =
                                  snapshot.data!;
