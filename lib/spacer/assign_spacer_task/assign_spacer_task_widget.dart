...
import '/spacer/spacer_quantity_assign_task/spacer_quantity_assign_task_widget.dart';
import 'dart:ui';
                            ...
                            Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: plantCatalogExpandable.length,
                                  itemBuilder:
                                      (context, plantCatalogExpandableIndex) {
                                                                    ...
                                                                    Row(
                                                                      mainAxisSize:
                                                                          MainAxisSize
                                                                              .max,
                                                                      children: [
                                                                        SpacerQuantityAssignTaskWidget(
                                                                          key: Key(
                                                                              'Keyshr_${plantCatalogExpandableIndex}_of_${plantCatalogExpandable.length}'),
                                                                          plantID:
                                                                              plantCatalogExpandableItem.plantId,
                                                                        ),
                                                                      ],
                                                                    ),
                                                                  ],
