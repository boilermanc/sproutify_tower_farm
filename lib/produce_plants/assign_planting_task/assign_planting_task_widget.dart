...
import 'assign_planting_task_model.dart';
export 'assign_planting_task_model.dart';

class AssignPlantingTaskWidget extends StatefulWidget {
  const AssignPlantingTaskWidget({
    super.key,
  ...
  @override
  State<AssignPlantingTaskWidget> createState() =>
      _AssignPlantingTaskWidgetState();
}

class _AssignPlantingTaskWidgetState extends State<AssignPlantingTaskWidget> {
  late AssignPlantingTaskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssignPlantingTaskModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FutureBuilder<List<TaskPlantingsRow>>(
                      future: TaskPlantingsTable().queryRows(
                        queryFn: (q) => q
                            .eqOrNull(
                              'farm_id',
                              FFAppState().farmID,
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<TaskPlantingsRow>
                            spacerContainerTaskPlantingsRowList =
                            snapshot.data!;
