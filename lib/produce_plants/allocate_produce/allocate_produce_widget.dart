                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_model.customerType ==
                            '646a19f2-8378-4a16-bc15-c05f772a27df')
                          Padding(
                            padding: EdgeInsets.all(12.0),
                            child: InkWell(
                              splashColor: Colors.transparent,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: FlutterFlowCountController(
                                        ...
                                        stepSize: 1,
                                        minimum: 1,
                                        maximum: widget!.availableQuantity!,
                                        contentPadding:
                                            EdgeInsetsDirectional.fromSTEB(
                                                12.0, 0.0, 12.0, 0.0),
                                      ),
                            ...
                            onPressed: () async {
                              await WeeklyGrowSheetTable().insert({
                                ...
                                'reserved_by_customer_id':
                                    _model.customerTypeValue,
                                'week_start_date':
                                    supaSerialize<DateTime>(_model.weekDate),
                                'item_id': widget!.itemID,
                              });
                              if (_model.customerType ==
                                  '646a19f2-8378-4a16-bc15-c05f772a27df') {
                                await WeeklyDeliveriesTable().insert({
                                  'customer_id': _model.customerTypeValue,
                                  'quantity': _model.countControllerValue,
                                  'delivery_date': supaSerialize<DateTime>(
                                      _model.deliverDate),
                                  'status': '',
