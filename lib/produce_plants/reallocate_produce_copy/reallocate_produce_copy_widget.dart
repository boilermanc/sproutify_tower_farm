...
import 'reallocate_produce_copy_model.dart';
export 'reallocate_produce_copy_model.dart';

class ReallocateProduceCopyWidget extends StatefulWidget {
  const ReallocateProduceCopyWidget({
    super.key,
  ...
  @override
  State<ReallocateProduceCopyWidget> createState() =>
      _ReallocateProduceCopyWidgetState();
}

class _ReallocateProduceCopyWidgetState
    extends State<ReallocateProduceCopyWidget> {
  late ReallocateProduceCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReallocateProduceCopyModel());
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            5.0, 0.0, 0.0, 0.0),
                                        child: Text(
                                          'Reallocate to a Different Customer',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                font:
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 0.0, 0.0, 0.0),
                                        child: Text(
                                          'Move this allocation to another customer',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                                font:
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 0.0, 0.0, 0.0),
                                        child: Text(
                                          'Item went bad or cannot be used',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                                font:
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            .wasteQuanityTextFieldTextController,
                                                        focusNode: _model
                                                            .wasteQuanityTextFieldFocusNode,
                                                        autofocus: false,
                                                        obscureText: false,
                                                        decoration:
                                                            InputDecoration(
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 0.0, 0.0, 0.0),
                                        child: Text(
                                          'Donate to foodbank or community',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                                font:
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            .donateQuanityTextFieldTextController,
                                                        focusNode: _model
                                                            .donateQuanityTextFieldFocusNode,
                                                        autofocus: false,
                                                        obscureText: false,
                                                        decoration:
                                                            InputDecoration(
