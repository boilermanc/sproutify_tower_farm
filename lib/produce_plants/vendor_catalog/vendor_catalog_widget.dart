...
import 'vendor_catalog_model.dart';
export 'vendor_catalog_model.dart';

class VendorCatalogWidget extends StatefulWidget {
  const VendorCatalogWidget({super.key});

  @override
  State<VendorCatalogWidget> createState() => _VendorCatalogWidgetState();
}

class _VendorCatalogWidgetState extends State<VendorCatalogWidget> {
  late VendorCatalogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VendorCatalogModel());
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return FlutterFlowDataTable<
                                      ...
                                      dataRowBuilder: (vendorCatalogItem,
                                              vendorCatalogIndex,
                                              selected,
                                              onSelectChanged) =>
                                          DataRow(
                                        color: MaterialStateProperty.all(
                                          vendorCatalogIndex % 2 == 0
                                              ? FlutterFlowTheme.of(context)
                                                  .secondaryBackground
                                              : FlutterFlowTheme.of(context)
                                                  .primaryBackground,
