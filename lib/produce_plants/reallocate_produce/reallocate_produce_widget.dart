...
import 'reallocate_produce_model.dart';
export 'reallocate_produce_model.dart';

class ReallocateProduceWidget extends StatefulWidget {
  ...
  State<ReallocateProduceWidget> createState() =>
      _ReallocateProduceWidgetState();
}

class _ReallocateProduceWidgetState extends State<ReallocateProduceWidget> {
  late ReallocateProduceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReallocateProduceModel());
