                              ...
                              child: FutureBuilder<List<FarmVendorsViewRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<FarmVendorsViewRow>
                                      dropDownFarmVendorsViewRowList =
                                      snapshot.data!;
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    ...
                                    options: List<String>.from(
                                        dropDownFarmVendorsViewRowList
                                            ...
                                            .withoutNulls
                                            .toList()),
                                    optionLabels: dropDownFarmVendorsViewRowList
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.quantityAddedTextController,
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.quantityOnHandTextController,
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await SeedInventoryTable().insert({
                                    ...
                                    'current_stock': int.tryParse(_model
                                        .quantityOnHandTextController.text),
                                    ...
                                    'quantity_added': int.tryParse(_model
                                        .quantityAddedTextController.text),
                                  });
                                  FFAppState().addSeed = '';
