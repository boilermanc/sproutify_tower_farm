...
import 'no_tasks_model.dart';
export 'no_tasks_model.dart';
...
class _NoTasksWidgetState extends State<NoTasksWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoTasksModel());
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                'All tasks completed—keep up the great work!\"',
