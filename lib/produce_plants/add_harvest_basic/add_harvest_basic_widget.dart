...
import 'add_harvest_basic_model.dart';
export 'add_harvest_basic_model.dart';

class AddHarvestBasicWidget extends StatefulWidget {
  const AddHarvestBasicWidget({
    super.key,
    ...
    required this.growingQuantity,
    int? towerContentID,
  }) : this.towerContentID = towerContentID ?? 0;
  ...
  final int? plantID;
  final int? towerID;
  final int? growingQuantity;
  final int towerContentID;

  @override
  State<AddHarvestBasicWidget> createState() => _AddHarvestBasicWidgetState();
}

class _AddHarvestBasicWidgetState extends State<AddHarvestBasicWidget> {
  late AddHarvestBasicModel _model;
                              ...
                              child: ExpandablePanel(
                                ...
                                expanded: Column(
                                  ...
                                  children: [
                                    wrapWithModel(
                                      model:
                                          _model.confirmTowerWasteNoButtonModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: ConfirmTowerWasteNoButtonWidget(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                'If you notice any serious issues with the plants, please notify your supervisor.',
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                                      fontFamily: 'Plus Jakarta Sans',
                        ...
                        if (_model.confirmTowerWasteNoButtonModel
                          ...
                          await ActionsTable().insert({
                            ...
                            'quantity': valueOrDefault<int>(
                              int.tryParse(_model.confirmTowerWasteNoButtonModel
                                  .wasteQuantityTextController.text),
                              0,
                            ),
                            'action_date':
