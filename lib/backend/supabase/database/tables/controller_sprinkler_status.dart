...
class ControllerSprinklerStatusTable
    extends SupabaseTable<ControllerSprinklerStatusRow> {
  @override
  String get tableName => 'controller_sprinkler_status';

  @override
  ControllerSprinklerStatusRow createRow(Map<String, dynamic> data) =>
      ControllerSprinklerStatusRow(data);
}

class ControllerSprinklerStatusRow extends SupabaseDataRow {
  ControllerSprinklerStatusRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ControllerSprinklerStatusTable();
