...
class SpacerWasteReasonsListTable
    extends SupabaseTable<SpacerWasteReasonsListRow> {
  @override
  String get tableName => 'spacer_waste_reasons_list';

  @override
  SpacerWasteReasonsListRow createRow(Map<String, dynamic> data) =>
      SpacerWasteReasonsListRow(data);
}

class SpacerWasteReasonsListRow extends SupabaseDataRow {
  SpacerWasteReasonsListRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SpacerWasteReasonsListTable();
