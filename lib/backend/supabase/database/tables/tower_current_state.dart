...
class TowerCurrentStateTable extends SupabaseTable<TowerCurrentStateRow> {
  @override
  String get tableName => 'tower_current_state';

  @override
  TowerCurrentStateRow createRow(Map<String, dynamic> data) =>
      TowerCurrentStateRow(data);
}

class TowerCurrentStateRow extends SupabaseDataRow {
  TowerCurrentStateRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TowerCurrentStateTable();
