...
class WeeklySeedingPlansTable extends SupabaseTable<WeeklySeedingPlansRow> {
  @override
  String get tableName => 'weekly_seeding_plans';

  @override
  WeeklySeedingPlansRow createRow(Map<String, dynamic> data) =>
      WeeklySeedingPlansRow(data);
}

class WeeklySeedingPlansRow extends SupabaseDataRow {
  WeeklySeedingPlansRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => WeeklySeedingPlansTable();
