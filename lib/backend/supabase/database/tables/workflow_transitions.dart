...
class WorkflowTransitionsTable extends SupabaseTable<WorkflowTransitionsRow> {
  @override
  String get tableName => 'workflow_transitions';

  @override
  WorkflowTransitionsRow createRow(Map<String, dynamic> data) =>
      WorkflowTransitionsRow(data);
}

class WorkflowTransitionsRow extends SupabaseDataRow {
  WorkflowTransitionsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => WorkflowTransitionsTable();
