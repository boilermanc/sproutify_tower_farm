...
class TaskListViewTable extends SupabaseTable<TaskListViewRow> {
  @override
  String get tableName => 'task_list_view';

  @override
  TaskListViewRow createRow(Map<String, dynamic> data) => TaskListViewRow(data);
}

class TaskListViewRow extends SupabaseDataRow {
  TaskListViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TaskListViewTable();
