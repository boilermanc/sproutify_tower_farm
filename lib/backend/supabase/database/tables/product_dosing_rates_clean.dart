...
class ProductDosingRatesCleanTable
    extends SupabaseTable<ProductDosingRatesCleanRow> {
  @override
  String get tableName => 'product_dosing_rates_clean';

  @override
  ProductDosingRatesCleanRow createRow(Map<String, dynamic> data) =>
      ProductDosingRatesCleanRow(data);
}

class ProductDosingRatesCleanRow extends SupabaseDataRow {
  ProductDosingRatesCleanRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ProductDosingRatesCleanTable();
