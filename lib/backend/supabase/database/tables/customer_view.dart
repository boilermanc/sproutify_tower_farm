...
class CustomerViewTable extends SupabaseTable<CustomerViewRow> {
  @override
  String get tableName => 'customer_view';

  @override
  CustomerViewRow createRow(Map<String, dynamic> data) => CustomerViewRow(data);
}

class CustomerViewRow extends SupabaseDataRow {
  CustomerViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => CustomerViewTable();
