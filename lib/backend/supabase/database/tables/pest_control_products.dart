...
class PestControlProductsTable extends SupabaseTable<PestControlProductsRow> {
  @override
  String get tableName => 'pest_control_products';

  @override
  PestControlProductsRow createRow(Map<String, dynamic> data) =>
      PestControlProductsRow(data);
}

class PestControlProductsRow extends SupabaseDataRow {
  PestControlProductsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PestControlProductsTable();
