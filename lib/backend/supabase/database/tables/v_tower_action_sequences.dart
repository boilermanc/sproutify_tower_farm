...
class VTowerActionSequencesTable
    extends SupabaseTable<VTowerActionSequencesRow> {
  @override
  String get tableName => 'v_tower_action_sequences';

  @override
  VTowerActionSequencesRow createRow(Map<String, dynamic> data) =>
      VTowerActionSequencesRow(data);
}

class VTowerActionSequencesRow extends SupabaseDataRow {
  VTowerActionSequencesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VTowerActionSequencesTable();
