...
class ProductPestChemicalsTable extends SupabaseTable<ProductPestChemicalsRow> {
  @override
  String get tableName => 'product_pest_chemicals';

  @override
  ProductPestChemicalsRow createRow(Map<String, dynamic> data) =>
      ProductPestChemicalsRow(data);
}

class ProductPestChemicalsRow extends SupabaseDataRow {
  ProductPestChemicalsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ProductPestChemicalsTable();
