...
class VendorsBackupTable extends SupabaseTable<VendorsBackupRow> {
  @override
  String get tableName => 'vendors_backup';

  @override
  VendorsBackupRow createRow(Map<String, dynamic> data) =>
      VendorsBackupRow(data);
}

class VendorsBackupRow extends SupabaseDataRow {
  VendorsBackupRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VendorsBackupTable();
