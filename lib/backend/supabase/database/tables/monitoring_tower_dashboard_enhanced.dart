...
class MonitoringTowerDashboardEnhancedTable
    extends SupabaseTable<MonitoringTowerDashboardEnhancedRow> {
  @override
  String get tableName => 'monitoring_tower_dashboard_enhanced';

  @override
  MonitoringTowerDashboardEnhancedRow createRow(Map<String, dynamic> data) =>
      MonitoringTowerDashboardEnhancedRow(data);
}

class MonitoringTowerDashboardEnhancedRow extends SupabaseDataRow {
  MonitoringTowerDashboardEnhancedRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MonitoringTowerDashboardEnhancedTable();
