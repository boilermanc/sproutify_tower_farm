...
class TowerDisplayWithPlantsTestTable
    extends SupabaseTable<TowerDisplayWithPlantsTestRow> {
  @override
  String get tableName => 'tower_display_with_plants_test';

  @override
  TowerDisplayWithPlantsTestRow createRow(Map<String, dynamic> data) =>
      TowerDisplayWithPlantsTestRow(data);
}

class TowerDisplayWithPlantsTestRow extends SupabaseDataRow {
  TowerDisplayWithPlantsTestRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TowerDisplayWithPlantsTestTable();
