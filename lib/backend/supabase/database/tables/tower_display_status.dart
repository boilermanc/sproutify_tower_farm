...
class TowerDisplayStatusTable extends SupabaseTable<TowerDisplayStatusRow> {
  @override
  String get tableName => 'tower_display_status';

  @override
  TowerDisplayStatusRow createRow(Map<String, dynamic> data) =>
      TowerDisplayStatusRow(data);
}

class TowerDisplayStatusRow extends SupabaseDataRow {
  TowerDisplayStatusRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TowerDisplayStatusTable();
