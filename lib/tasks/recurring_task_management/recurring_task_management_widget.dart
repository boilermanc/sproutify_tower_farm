...
class RecurringTaskManagementWidget extends StatefulWidget {
  const RecurringTaskManagementWidget({super.key});

  @override
  State<RecurringTaskManagementWidget> createState() =>
      _RecurringTaskManagementWidgetState();
}

class _RecurringTaskManagementWidgetState
    extends State<RecurringTaskManagementWidget> {
  late RecurringTaskManagementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecurringTaskManagementModel());
