...
class _UpdateVendorWidgetState extends State<UpdateVendorWidget> {
  ...
  void initState() {
    ...
    _model.vendorNameTextFieldTextController ??= TextEditingController(
    ...
    _model.vendorPhoneTextFieldTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget!.vendorPhone,
      'Phone',
    ));
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(10.0, 20.0, 0.0, 5.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Text(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 300.0,
                        child: TextFormField(
                          controller: _model.vendorNameTextFieldTextController,
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 300.0,
                        child: TextFormField(
                          controller: _model.vendorPhoneTextFieldTextController,
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await FarmVendorsTable().update(
                              data: {
                                'contact_info': _model
                                    .vendorNameTextFieldTextController.text,
                                'contact_number': _model
                                    .vendorPhoneTextFieldTextController.text,
                              },
