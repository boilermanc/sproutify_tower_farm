...
class UpdateEmployeeRoleWidget extends StatefulWidget {
  ...
  })  : this.employeeFirstName = employeeFirstName ?? 'First',
        this.employeeLastName = employeeLastName ?? 'Last';
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              if (rolesListItem.isSelected == true) {
                                                                                await ProfileRolesTable().delete(
                                                                                ...
                                                                                await ProfileRolesTable().insert({
                                                                                  'profile_id': widget!.employeeID,
                                                                                  'role_id': rolesListItem.roleId,
                                                                                });
                                                                              }
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              decoration: BoxDecoration(
                                                                                color: colorFromCssString(
                                                                                  rolesListItem.isSelected == true ? '#A0F0A0' : '#ffffff',
