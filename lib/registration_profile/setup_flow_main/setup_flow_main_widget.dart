...
import 'setup_flow_main_model.dart';
export 'setup_flow_main_model.dart';

class SetupFlowMainWidget extends StatefulWidget {
  const SetupFlowMainWidget({super.key});

  @override
  State<SetupFlowMainWidget> createState() => _SetupFlowMainWidgetState();
}

class _SetupFlowMainWidgetState extends State<SetupFlowMainWidget> {
  late SetupFlowMainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SetupFlowMainModel());

    _model.farmNameTextController ??= TextEditingController();
    _model.farmNameFocusNode ??= FocusNode();

    _model.farmAddressTextController ??= TextEditingController();
    _model.farmAddressFocusNode ??= FocusNode();
    ...
    _model.howWillYouUseThisTextFieldTextController ??= TextEditingController();
    _model.howWillYouUseThisTextFieldFocusNode ??= FocusNode();
                            ...
                            children: [
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      'Cultivate success with Sproutify – tell us about your farm.',
                                      ...
                                      Flexible(
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .farmAddressTextController,
                                              focusNode:
                                                  _model.farmAddressFocusNode,
                                              autofocus: true,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                              ...
                                              validator: _model
                                                  .farmAddressTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                        ...
                                        Form(
                                          ...
                                          child: Padding(
                                            ...
                                            child: FlutterFlowDropDown<bool>(
                                              controller: _model
                                                      .supplementalLightingDropDownValueController ??=
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              if (_model.farmUnitValue ==
                                                  null) {
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(
                                                  SnackBar(
                                                    content: Text(
                                                      'Please select a unit of measurment',
                                                      style: TextStyle(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  100.0, 10.0, 0.0, 0.0),
                                          child: Text(
                                            'How will you use this tool on your farm?',
                                            style: FlutterFlowTheme.of(context)
                                                .headlineSmall
                                                .override(
                                                  font: GoogleFonts.outfit(
                                          ...
                                          child: Container(
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                focusNode: _model
                                                    .howWillYouUseThisTextFieldFocusNode,
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Flexible(
                                            child: Text(
                                              'Thanks for providing that information. Your farm is almost ready to go!',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .headlineMedium
                                                      .override(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Flexible(
                                            child: Text(
                                              'The best place to start is by adding your tower system. If you want to skip this now you can and then add them later. ',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .headlineMedium
                                                      .override(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                // Update Tower Config State
                                                FFAppState().towersConfigured =
                                                    false;
                                                FFAppState()
                                                        .towersAreConfigured =
                                                    false;
