...
class InvitationCreateAccountWidget extends StatefulWidget {
  const InvitationCreateAccountWidget({
    super.key,
  ...
  @override
  State<InvitationCreateAccountWidget> createState() =>
      _InvitationCreateAccountWidgetState();
}

class _InvitationCreateAccountWidgetState
    extends State<InvitationCreateAccountWidget> {
  late InvitationCreateAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvitationCreateAccountModel());

    _model.emailTextFieldTextController ??=
        TextEditingController(text: FFAppState().profileEmail);
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  10.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            'Complete your account setup to join the farm!',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.confirmTextFieldTextController,
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model
                                    ...
                                    _model
                                        .confirmTextFieldTextController.text) {
