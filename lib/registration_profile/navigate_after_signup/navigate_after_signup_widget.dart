...
import 'navigate_after_signup_model.dart';
export 'navigate_after_signup_model.dart';
...
class NavigateAfterSignupWidget extends StatefulWidget {
  ...
  State<NavigateAfterSignupWidget> createState() =>
      _NavigateAfterSignupWidgetState();
}

class _NavigateAfterSignupWidgetState extends State<NavigateAfterSignupWidget> {
  late NavigateAfterSignupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavigateAfterSignupModel());
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<List<RolesRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<RolesRow> selectRoleRolesRowList =
                              snapshot.data!;
                          ...
                          return FlutterFlowDropDown<String>(
                            ...
                            options: List<String>.from(selectRoleRolesRowList
                                .map((e) => e.id)
                                .toList()),
                            optionLabels: selectRoleRolesRowList
                                .map((e) => e.roleName)
                                .toList(),
