...
export 'profile_upload_model.dart';

class ProfileUploadWidget extends StatefulWidget {
  const ProfileUploadWidget({super.key});

  @override
  State<ProfileUploadWidget> createState() => _ProfileUploadWidgetState();
}

class _ProfileUploadWidgetState extends State<ProfileUploadWidget> {
  late ProfileUploadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileUploadModel());
