                          ...
                          child: InkWell(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                if (_model.applicationDate != null)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        5.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                    ...
                                    FutureBuilder<List<ViewProfileRolesRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<ViewProfileRolesRow>
                                            selectApplicatorViewProfileRolesRowList =
                                            snapshot.data!;

                                        return FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .selectApplicatorValueController ??=
                                              FormFieldController<String>(
                                            _model.selectApplicatorValue ??= '',
                                          ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: [
                                    FutureBuilder<List<PestLocationsRow>>(
                                      future: PestLocationsTable().queryRows(
                                        queryFn: (q) =>
                                            q.order('location_name'),
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                        ...
                                        List<PestLocationsRow>
                                            selectLocationPestLocationsRowList =
                                            snapshot.data!;

                                        return FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .selectLocationValueController ??=
                    ...
                    Flexible(
                      child: Padding(
                        ...
                        child: Container(
                          width: 400.0,
                          decoration: BoxDecoration(
                            color: _model.confirmSafetyRequirments == null
                                ? Color(0xFFEED0C3)
                                : Color(0xFFD2E9C4),
                            borderRadius: BorderRadius.circular(8.0),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                Theme(
                                  ...
                                  child: Checkbox(
                                    value: _model.protocolsValue ??= true,
                                    onChanged: (newValue) async {
                                      safeSetState(() =>
                                          _model.protocolsValue = newValue!);
                                      if (newValue!) {
                                        _model.confirmSafetyRequirments = true;
                                        safeSetState(() {});
                                      }
                                    },
                                    side: BorderSide(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await PestControlApplicationsTable().insert({
                              'farm_id': FFAppState().farmID,
                              'user_id': currentUserUid,
                              'method_id':
                                  '0ab7680a-be6f-4953-935b-c6e9a7e54407',
                              'treatment_area': _model.selectLocationValue,
                              'application_date': supaSerialize<DateTime>(
                                  _model.applicationDate),
                              'created_at':
